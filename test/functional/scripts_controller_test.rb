...
class ScriptsControllerTest < ActionController::TestCase
  ...
  test "should create script" do
    assert_difference('Script.count') do
      post :create, script: { down: @script.down, left: @script.left, name: @script.name, right: @script.right, up: @script.up, url: @script.url }
    end
  ...
  test "should update script" do
    put :update, id: @script, script: { down: @script.down, left: @script.left, name: @script.name, right: @script.right, up: @script.up, url: @script.url }
    assert_redirected_to script_path(assigns(:script))
  end
